<img width="623" height="234" alt="Снимок экрана 2026-05-03 в 01 34 07" src="https://github.com/user-attachments/assets/0aa4f4cd-b9f8-4450-8217-559e29f4ce2f" />**University:** ITMO University  
**Faculty:** [FTMI]  
...
2. Создала виртуальную машину с заданными условиями лабы параметрами:  
...
3. В качестве сервисного аккаунта выбрала свой, созданный шагом ранее:  
...
8. Несмотря на замену роли копирование все еще было разрешено, при этом я проверила, какой аккаунт привязан - все было верно:
<img width="612" height="233" alt="Снимок экрана 2026-05-03 в 01 35 12" src="https://github.com/user-attachments/assets/d712a2ea-1440-440e-81d1-5ae8c8b02739" />  

9. Через время при попытке копировать доступ уже был запрещен:  
<img width="605" height="64" alt="Снимок экрана 2026-05-03 в 01 30 26" src="https://github.com/user-attachments/assets/548c764f-ddd4-429a-8705-f10b17d82e0b" />
...
Результат изменения ролей не всегда появляется сразу же, так как скорее всего используются ранее выданные токены доступа.  Через время все работает корректно.  
